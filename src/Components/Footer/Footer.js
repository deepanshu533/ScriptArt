        ...
        <div className="footer">
            <div className="footer_container">
                ...
                <p>
                    ...
                    <a href='https://github.com/deepanshi533/ScriptArt/tree/main' target="_blank" rel="noopener noreferrer">
            ...
            <div className="footer_hrt">
                <h3>Made with <span role="img" aria-label="necro">❤️</span> by <a href='https://github.com/deepanshi533' target="_blank" rel="noopener noreferrer">Deepanshi</a></h3>
            </div>
